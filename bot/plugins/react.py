...
# Apply user filter to command handlers only
@TelegramBot.on_message(filters.command(['target', 'enough']) & filters.user(AUTHORIZED_USERS))
async def restricted_commands(_, msg: Message):
    # Allow only authorized users to execute commands
    pass
